...
public class CmmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "INT_CONSTANT", "REAL_CONSTANT", "REAL_FLOATING", 
			"REAL_MANTISSA", "CHAR_CONSTANT", "AUX_CHAR_CONSTANT1", "AUX_CHAR_CONSTANT2", 
			"ONE_LINE_COMMENT", "MULTIPLE_LINE_COMMENTS", "ID", "WHITE_SPACES", "DIGIT", 
			"LETTER", "ID_COMPONENT", "EXPONENT"
		};
	}
